...
public class Proposal {
	...
	public static void generateProposals(MapLocation locus, int distToLocus,int incrementalDist,ArrayList<Proposal> proposalList, Direction[] consideredDirs, BreadthFirst bfs){
